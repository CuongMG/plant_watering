...
#define BLYNK_TEMPLATE_ID "TMPL6MpD4fEMl"
#define BLYNK_TEMPLATE_NAME "esp32"
#define BLYNK_AUTH_TOKEN "IogqmfQx_Rj-S5jtTluPdF0ongxyTymw"
...
const char* ssid = "cosmic"; //WiFi Name
const char* pass = "aptx48694062"; //WiFi Password
